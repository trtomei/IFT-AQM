...
%\author{The Author}
\date{May 11, 2023}                                           % Activate to display a given date or no date
...
since
\be
\frac{d}{d t}\langle\hat{A}\rangle_{\varphi}=\frac{i}{\hbar}\langle[\hat{H}, \hat{A}]\rangle_{\varphi}
\ee
...
\fbox{\begin{minipage}[t]{1.0\linewidth}
\setcounter{equation}{8}
\emph{Remember that:} 
\be
(\hat{\Theta}\varphi,\hat{\Theta}\chi) = (\chi,\varphi)
\label{eq:antiunitary}
\ee
since $\hat{\Theta}$ is antiunitary.
...
\be
\hat{U}_{t}\equiv\sum_{n}|n_{t}\rangle\langle n|=\sum_{n}| \hat{\Theta} n\rangle\langle n|
\label{eq:g110}
\ee
therefore
\be
...
& = \sum_{n} \bra{n} \ket{\hat{\Theta}\varphi} \underbrace{c^*c}_{1} \bra{\hat{\Theta}\varphi} \ket{n}
 = \sum_{n} \bra{\hat{\Theta}\varphi} \ket{n}\bra{n} \ket{\hat{\Theta}\varphi}\\
& = \bra{\hat{\Theta}\varphi} \ket{\hat{\Theta}\varphi} = \bra{\varphi}\ket{\varphi},\text{ by Eq.~\eqref{eq:antiunitary}}.
\end{aligned}
\ee
...
&=\hat{\Theta} \sum_{n}|n\rangle\langle n | \varphi\rangle=\sum_{n}\left|n_{t}\right\rangle\langle n | \varphi\rangle^{*},\text{use Eq.~\eqref{eq:g110}} \\
&=\sum_{n} \hat{U}_{t}|n\rangle\langle n | \varphi\rangle^{*} =\hat{U}_{t} \sum_{n}|n\rangle\langle n | \varphi\rangle^{*} \\ 
&=\hat{U}_{t} \sum_{n}\langle n | \varphi\rangle^{*}|n\rangle = \hat{U}_{t} \sum_n c_n^* \ket{n}
\end{aligned}
\label{eq:g114}
\ee
