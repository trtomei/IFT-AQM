...
%\author{The Author}
\date{April 04, 2023}                                           % Activate to display a given date or no date
...
\right)\\
&=\frac{1}{2}\left[
\op{+}{+}\underbrace{\Tr(\op{-}{-})}_1 -
\op{+}{-}\underbrace{\Tr(\op{-}{+})}_0 -
\op{-}{+}\underbrace{\Tr(\op{+}{-})}_0 +
\op{-}{-}\underbrace{\Tr(\op{+}{+})}_1
\right]\\
&=\frac{1}{2}\left(
...
\begin{aligned}
%%% 6 OK
i\hbar \frac{d}{dt} \hat{P}_\varphi(t)
...
\text{where } \omega_0 = \gamma B \text{ and we use the weak field approx. (high $T$)}\\
\Tr e^{-\beta \hat{H}} \approx 2
\end{gathered}
\ee
hence
\be
\hat{\rho} \simeq 1 / 2\left(I+\beta \frac{\hbar \omega_{0}}{2} \sigma_{z}\right) \Rightarrow 
b_{z}= \beta \frac{\hbar \omega_{0}}{2}
\ee
...
\be
\hat{\rho}\left( \frac{\pi}{2 \omega_{1}}\right)=
