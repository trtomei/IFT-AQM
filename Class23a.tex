...
%\author{The Author}
\date{May 23, 2023}                                           % Activate to display a given date or no date
...
\be
\left(\hat{H}_{0}-E_{n}^{(0)}\right)\left|\varphi_{n}^{(0)}\right\rangle= 0
\ee
...
\left(\lambda\left\langle\varphi_{\bar{n}}^{(0)}|\hat{W}| \varphi_{\bar{m}}^{(0)}\right\rangle
