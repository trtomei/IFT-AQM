...
%\author{The Author}
\date{June 13, 2023}                                           % Activate to display a given date or no date
...
\be
i \hbar \frac{d \hat{\rho}(t)}{d t}=\left[\hat{H}(R), \hat{P}_{n}(R)\right]=0
\label{eq:g99}
\ee
which means
\be
...
\rule{\textwidth}{1pt}
\be
\frac{\left\langle m ; R\left|\frac{d\hat{H}}{d t}\right| n ; R\right\rangle}%
{E_{n}(R)-E_{m}(R)}
 = 0,\,m \neq n
\label{eq:g108}
\ee
...
\vec{A}_{n}(R) \rightarrow \vec{A}_{n}^{\prime}(R) 
