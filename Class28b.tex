...
%\author{The Author}
\date{June 27, 2023}                                           % Activate to display a given date or no date
...
\be
\vec{k}_{1}^{\prime} = \vec{k}_{1}+\vec{q} = 
\vec{k}+\vec{q},\quad
\vec{k}_{2}^{\prime} = \vec{k}_{2} - (\vec{k}_{1}^{\prime}-\vec{k_1}) =
\vec{p}-\vec{q}
\ee
%%% 06 OKAY
...
\delta_{k_{1}+k_{2}, k_{1}^{\prime} + k_{2}^{\prime}}
\left[
\widetilde{V}_2(\vec{k}_{1}^{\prime}-\vec{k}_{1})\delta_{m_{1}^{\prime} m_{1}}\delta_{m_{2}^{\prime} m_{2}}
\pm
\widetilde{V}_2(\vec{k}_{1}^{\prime}-\vec{k}_{2})\delta_{m_{1}^{\prime} m_{2}}\delta_{m_{2}^{\prime} m_{1}}
\right]\\
