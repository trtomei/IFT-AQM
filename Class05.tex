...
\]
\be
\Omega \equiv \sqrt{\delta^{2}+\omega_{1}^{2}}=
\sqrt{\left(\omega-\omega_{0}\right)^{2}+\omega_{1}^{2}}
\Rightarrow
\Omega_+ - \Omega_- = \Omega
\ee
finally leading to
...
%%% 8
\be
\gamma_{-}(t)=\frac{2 \Omega_{+}}{\omega_{1}} \lambda e^{i\left(\Omega_{+}-\delta\right) t}+
              \frac{2 \Omega_{-}}{\omega_{1}} \mu     e^{i\left(\Omega_{-}-\delta\right) t}
\ee
...
\ee
\be
\mu    =\frac{\Omega_{+}}{\Omega}= \frac{1}{2 \Omega}(\delta+\Omega)=\frac{1}{2}+\frac{\delta}{2 \Omega}
\ee
